...
// import ViewShoppingCart from './pages/ViewShoppingCart.jsx'
   ...
   import HomePlayer from './pages/HomePlayer.jsx'
...
function App() {
  const title = 'MERN App: Mongodb, Express, Reactjs and Nodejs'
  const titleMemoListHeader = 'Example of Architectura of microservices.'
  const subtitleMemoListHeader = 'MERN App (Mongodb-Express-React-Nodejs)'
  const titleSite = 'Music Shop Records online'
  ...
  //     credentials: 'include'
  //   }).then((response) => {
  //     console.log(`Response of fetch: 'http://localhost:3001/users/loggedIn', is:  ${response}`)
