  ...
  return (
    <div className="containerMenu">
      <div className="decriptionMenu">
        ...
        <span className="RSMTitle">Navigation Menu</span>
        <figure className="figureContainer">
          <img id="imgLogo1" src="./src/assets/images/logos/footerFondo.jpg" />
          <img id="imgLogo2" src="./src/assets/images/logos/isc2Logo.jpeg" />
        </figure>
      </div>
