...
import '../../sass/componentSass/Avatar/BoxSelectAvatar.scss'
  ...
  return (
    <div className="contAllAvatar">
          ...
          <ul className="UlAvatar">
            <li className="liAvatar">
              <div className="rbutton_Img">
                ...
                <figure className="figImgAvatar">
                  <img className="imgAvatar" src={`../../src/assets/Avatar/${'Paul-Avatar.jpg'}`} alt={'Paul Avatar'} />
                </figure>
              </div>
            ...
            <li className="liAvatar">
              <div className="rbutton_Img">
                ...
                <figure className="figImgAvatar">
                  <img className="imgAvatar" src={`../../src/assets/Avatar/${'George-Avatar.jpg'}`} alt={'George Avatar'} />
                </figure>
              </div>
              <div className="txtAvatar">
            ...
            <li className="liAvatar">
              <div className="rbutton_Img">
                ...
                <figure className="figImgAvatar">
                  <img className="imgAvatar" src={`../../src/assets/Avatar/${'John-Avatar.jpg'}`} alt={'John Avatar'} />
                </figure>
              </div>
              <div className="txtAvatar">
            ...
            <li className="liAvatar">
              <div className="rbutton_Img">
                ...
                <figure className="figImgAvatar">
                  <img className="imgAvatar" src={`../../src/assets/Avatar/${'Ringo-Avatar.jpg'}`} alt={'Ringo Avatar'} />
                </figure>
              </div>
              <div className="txtAvatar">
      ...
      <div className="contTextPersonAvatar" >
        ...
        <figure className="figImgAvatar">
          <img className="imgAvatar" src={`../../src/assets/Avatar/${avatarPers}`} alt={'Person Avatar'} />
        </figure>
      </div>
    </div>
