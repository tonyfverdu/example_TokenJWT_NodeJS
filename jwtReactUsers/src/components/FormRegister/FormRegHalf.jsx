...
import '../../sass/componentSass/FormRegister/FormRegHalf.scss'
  ...
  return (
    <>
      ...
      <figure className="figureImageCreditCard">
        ...
        <img className='imageCardCreditst' src={`../../src/assets/images/CreditDebitCards.png`} alt={'Image of Credit Cards'} />
      </figure>
    </>
  )
}