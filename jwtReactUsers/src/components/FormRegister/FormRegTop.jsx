...
import '../../sass/componentSass/FormRegister/FormRegTop.scss'
...
export default function FormRegTop() {
  const messageFormularRegisterCustomer = {
    ...
    placeHolderConfirmPassport: 'Confirm your password ...'
  }
    ...
    <>
      ...
      <div className="containerDataOfRegister_2">
        ...
        <div className="containerEmail_Password">
          <div className="containerInputLabel2">
          ...
          <div className="containerInputLabel2">
            ...
            <div className="containerCheckbox">
              <label className="labelOfCheckbox">
